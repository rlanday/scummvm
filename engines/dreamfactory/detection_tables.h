...
#ifndef DREAMFACTORY_DETECTION_TABLES_H
#define DREAMFACTORY_DETECTION_TABLES_H

namespace DreamFactory {

static const DreamFactoryGameDescription gameDescriptions[] = {
...
#endif // DREAMFACTORY_DETECTION_TABLES_H
