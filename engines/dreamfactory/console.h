...
#ifndef DREAMFACTORY_CONSOLE_H
#define DREAMFACTORY_CONSOLE_H
...
public:
	explicit Console(DreamFactoryEngine &engine);
...
private:
	...
	DreamFactoryEngine &_engine;
};

} // End of namespace DreamFactory

#endif // DREAMFACTORY_CONSOLE_H
