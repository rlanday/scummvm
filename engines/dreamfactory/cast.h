...
#ifndef DREAMFACTORY_CAST_H
#define DREAMFACTORY_CAST_H
...
/**
 * A DreamFactory cast file (.CST under DATA/): the global actor list and shared
...
public:
	struct Actor {
		...
		Common::String sceneName; ///< actorstar(): named SET placement point, record +0x70.
		Common::String shapeName; ///< actorpose(): named CST visual shape/animation, record +0x80.
		...
		int32 turn = 0;
		int32 value = 0;
		uint16 poseIndex = 0; ///< Animation step within shapeName, not an index into shapes.
