...
#ifndef DREAMFACTORY_STAGE_H
#define DREAMFACTORY_STAGE_H
...
/**
 * A DreamFactory "stage" (a @c .STG deck under DATA/): the navigable world of a
 ...
 * @c sendtostage(0) (openstagefile = TI.EXE FUN_004090b0 -> FUN_00409150
 * parse; node render = FUN_0040b180).
 *
