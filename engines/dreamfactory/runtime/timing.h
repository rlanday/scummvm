...
#ifndef DREAMFACTORY_RUNTIME_TIMING_H
#define DREAMFACTORY_RUNTIME_TIMING_H
...
/**
 * Script compositor pacing, not an FPS counter or a display refresh setting.
 * The native framerate value is an interval in 60 Hz ticks. forceUpdate()
 * waits against the last completed pass; movies/puppet speech use other clocks.
 */
