...
#ifndef DREAMFACTORY_RUNTIME_ACTORS_H
#define DREAMFACTORY_RUNTIME_ACTORS_H
...
public:
	...
	bool resolveActorStar(DreamFactoryEngine &engine, Cast::Actor &actor);
	void refreshActorStarPositions(DreamFactoryEngine &engine);
	void collectWorldActors(DreamFactoryEngine &engine, Common::Array<DrawEntry> &draw,
			const Shop::WorldCamera &camera) const;
	void openCastFile(DreamFactoryEngine &engine, const Common::String &name);
	void closeCastFile(DreamFactoryEngine &engine, const Common::String &name);
	void actorInstance(DreamFactoryEngine &engine, const Common::String &source, const Common::String &newName);
	void sendToCast(DreamFactoryEngine &engine, const Common::String &castName,
			const Common::String &message, const Common::Array<Value> &args);
	Value sendToCastFx(DreamFactoryEngine &engine, const Common::String &castName,
			const Common::String &message, const Common::Array<Value> &args);
	void sendToActor(DreamFactoryEngine &engine, const Common::String &actorName,
			const Common::String &message, const Common::Array<Value> &args);
	Value sendToActorFx(DreamFactoryEngine &engine, const Common::String &actorName,
			const Common::String &message, const Common::Array<Value> &args);
	int countActors() const;
	Common::String indexToActor(int index) const;
	bool getActorVisible(const Common::String &name) const;
	bool setActorVisible(DreamFactoryEngine &engine, const Common::String &name, bool visible);
	Common::String getActorSet(const Common::String &name) const;
	Common::String setActorSet(DreamFactoryEngine &engine, const Common::String &name, const Common::String &newSet);
	Common::String getActorStar(const Common::String &name) const;
	Common::String setActorStar(DreamFactoryEngine &engine, const Common::String &name, const Common::String &newStar);
	Common::String getActorPose(const Common::String &name) const;
	Common::String setActorPose(DreamFactoryEngine &engine, const Common::String &name, const Common::String &newPose);
	void actorXYZ(DreamFactoryEngine &engine, const Common::String &name, int x, int y, int z);
	int actorXYZ(DreamFactoryEngine &engine, const Common::String &name, int selector) const;
	int getActorDeg(const Common::String &name) const;
	int setActorDeg(DreamFactoryEngine &engine, const Common::String &name, int newDeg);
	int getActorDist(DreamFactoryEngine &engine, const Common::String &name) const;
	void setActorDist(DreamFactoryEngine &engine, const Common::String &name, int newDist);
	...
	void actorZClip(DreamFactoryEngine &engine, const Common::String &name, int zClip);
	void actorSpeed(const Common::String &name, int speed);
	void actorScale(DreamFactoryEngine &engine, const Common::String &name, int scale);
	void actorTurn(const Common::String &name, int turn);
	void turnToDeg(DreamFactoryEngine &engine, const Common::String &name, int deg);
	void walkToStar(DreamFactoryEngine &engine, const Common::String &name, const Common::String &star);
	void walkOnPath(DreamFactoryEngine &engine, const Common::String &name, const Common::String &path,
			const Common::String &dest);
	void walkToXYZ(DreamFactoryEngine &engine, const Common::String &name, int x, int y, int z);
	 ...
	 */
	void advanceWalks(DreamFactoryEngine &engine);
	...
	int starXYZ(DreamFactoryEngine &engine, const Common::String &name, int selector) const;
...
private:
	...
	void queueAnimatedWalk(DreamFactoryEngine &engine, Cast::Actor &actor,
			const Common::String &name, const Common::String &dest,
			int16 destX, int16 destY, int16 destZ);
	void dispatchTurnComplete(DreamFactoryEngine &engine, const Common::String &name);
	void clearWalkRecord(const Common::String &name);
	void dispatchWalkComplete(DreamFactoryEngine &engine, const Common::String &name);
	bool recoverExtraBaseActor(DreamFactoryEngine &engine, const Common::String &name);
	bool recoverGeneratedExtraActor(DreamFactoryEngine &engine, const Common::String &name);
