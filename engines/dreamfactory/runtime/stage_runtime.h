...
#ifndef DREAMFACTORY_RUNTIME_STAGE_RUNTIME_H
#define DREAMFACTORY_RUNTIME_STAGE_RUNTIME_H
...
public:
	...
	void openStageFile(DreamFactoryEngine &engine, const Common::String &name);
	void closeStageFile(DreamFactoryEngine &engine);
	void gotoFlat(DreamFactoryEngine &engine, const Value &flat);
	...
	void sendToStage(DreamFactoryEngine &engine, const Common::String &message, const Common::Array<Value> &args);
	Value sendToStageFx(DreamFactoryEngine &engine, const Common::String &message, const Common::Array<Value> &args);
	void sendToFlat(DreamFactoryEngine &engine, const Common::String &flat, const Common::String &message,
			const Common::Array<Value> &args);
	Value sendToFlatFx(DreamFactoryEngine &engine, const Common::String &flat, const Common::String &message,
			const Common::Array<Value> &args);
	void sendToButton(DreamFactoryEngine &engine, const Common::String &flat, const Common::String &button,
			const Common::String &message, const Common::Array<Value> &args);
	Value sendToButtonFx(DreamFactoryEngine &engine, const Common::String &flat, const Common::String &button,
			const Common::String &message, const Common::Array<Value> &args);
	 ...
	 */
	void renderStageNode(DreamFactoryEngine &engine, int node, bool resetCursor = true,
			bool present = true);
	void repaintDirtyStageRects(DreamFactoryEngine &engine, bool present = true);
	...
	void restoreSnapshot(const Snapshot &snapshot, const Common::SharedPtr<Stage> &preparedStage);
...
private:
	bool dispatchFlatMessage(DreamFactoryEngine &engine, const Common::SharedPtr<Stage> &dispatchStage,
			int dispatchNode, const Common::String &message, const Common::Array<Value> &args);
	bool queueStageNodeRedraw(DreamFactoryEngine &engine, int targetNode);
