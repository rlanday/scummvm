...
#ifndef DREAMFACTORY_SAVELOAD_H
#define DREAMFACTORY_SAVELOAD_H
 ...
 */
static const char kDreamFactorySaveMagic[4] = {'D', 'F', 'X', 'S'};

enum {
	kDreamFactorySaveVersion = 1
};
