...
CyberFlix's proprietary, Mac-authored \emph{DreamFactory 4} runtime (internal
signature \code{LPPALPPA}), a later generation of the engine used by \emph{Dust:
A Tale of the Wired West}. This is a
...
\begin{itemize}[nosep]
  \item New plugin \code{engines/dreamfactory/} (name TBD; avoids clash with
